...
**Reference implementation to copy conventions from:** `../vis-timeline`
...
```bash
cp ../vis-timeline/tsconfig.json tsconfig.json
cp ../vis-timeline/esbuild.config.mjs esbuild.config.mjs
cp ../vis-timeline/eslint.config.mts eslint.config.mts
cp ../vis-timeline/version-bump.mjs version-bump.mjs
```
...
```bash
cp ../vis-timeline/LICENSE LICENSE
...
```bash
cp ../vis-timeline/src/data-url.ts src/data-url.ts
cp ../vis-timeline/src/export-asset.ts src/export-asset.ts
cp ../vis-timeline/src/rasterize.ts src/rasterize.ts
```
